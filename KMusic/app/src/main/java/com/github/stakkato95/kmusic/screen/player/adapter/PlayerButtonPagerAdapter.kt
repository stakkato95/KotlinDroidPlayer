...
import com.github.stakkato95.kmusic.screen.player.ui.TrackProgressAwareFragment
...
class PlayerButtonPagerAdapter(fm: FragmentManager,
    ...
    override fun getItem(position: Int) = TrackProgressAwareFragment.newInstance(progressCallback, playPauseCallback, position)
